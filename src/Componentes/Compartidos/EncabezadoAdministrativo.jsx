    ...
    <>
      <style>{`
        :root {
          ...
          --color-highlight: #4682B4; /* Azul intermedio */
          --color-hover: #87CEFA; /* Azul claro para hover */
          --color-mobile-bg: #B0E0E6; /* Azul claro para el menú móvil */
        ...
        @media (max-width: 768px) {
          .menu ul {
            ...
            width: 70%;
            height: 100%;
            background-color: var(--color-mobile-bg); /* Color de fondo del menú móvil */
            padding: 20px;
